...
export const SponsorsTicker: React.FC = () => {
  ...
  return (
    <div className="h-20 md:h-24 w-full">
      <div className="fixed top-0 left-0 right-0 z-[100] w-full bg-white border-b border-neutral-200 h-20 md:h-24 flex items-center shadow-md overflow-hidden select-none">
